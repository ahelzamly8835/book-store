        ...
        <div className="flex justify-center items-center px-4 md:py-10 py-8">
          <div className="form flex flex-col w-full max-w-xl">
            ...
            <div className="content text-[#22222280] flex flex-col mx-auto">
              ...
              <p className="w-60 mt-10 md:w-full md:mt-0">
                Your new password must be different from previous one
              </p>
            </div>
            <Formik>
              <Form className="form flex flex-col  w-full max-w-xl">
                <label className="text-[#222222] my-2 md:mt-20 mt-10 text-[18px] ml-1 font-semibold">
                  password
                </label>
                <Field
                  id="password"
                  name="password"
                  type="text"
                  className="bg-white mb-2 focus:outline-none px-4 py-2 rounded-lg border border-transparent focus:border-mainColor transition-all"
                ...
                />
                <label htmlFor="" className="text-[#22222280] mb-10">
                  Must be at least 8 characterss
                </label>
                <label
                  htmlFor="password"
                  className="text-[#222222] mb-2  text-[18px] ml-1 font-semibold"
                >
                  Confirm password
                </label>
                <Field
                  ...
                  type="password"
                  id="password"
                  className="bg-white focus:outline-none px-4 py-2 rounded-lg border border-transparent focus:border-mainColor transition-all"
                ...
                <button
                  type="submit"
                  className="btn cursor-pointer mb-80 bg-mainColor flex justify-center items-center mt-8 rounded-lg py-2.5 text-white font-bold transition-opacity hover:opacity-90"
                >
                  Reset password
                </button>
              </Form>
