...
const SignupPage = () => {
  ...
  const handlerigester = async (values) => {
    try {
      ...
      await axios.post("https://bookstore.eraasoft.pro/api/register", data);
            ...
            <Form className="form flex flex-col w-full max-w-xl">
              <div className="mobile-only md:hidden">
                ...
                <Field
                  type="text"
                  name="username"
                  className=" bg-white w-full mb-3 px-3 py-2 sm:px-4 rounded-lg border border-transparent focus:border-mainColor focus:outline-none transition-all text-sm sm:text-base"
              ...
              <div className="md:flex hidden gap-4">
                <label htmlFor="">
                  ...
                  <Field
                    name="firstName"
                    type="text"
                    className="bg-white mb-3 focus:outline-none px-4 w-70 py-2 rounded-lg border border-transparent focus:border-mainColor transition-all"
                    placeholder="John"
                  />
                  <ErrorMessage
                    name="firstName"
              ...
              <Field
                name="email"
                type="text"
                className="bg-white mb-3 focus:outline-none px-4 py-2 rounded-lg border border-transparent focus:border-mainColor transition-all"
              ...
              <p className="text-[#222222] my-2  text-[18px] ml-1">
                Confirm password
              </p>
              <Field
                name="ConfirmPassword"
                type="password"
                className="bg-white focus:outline-none mb-3 px-4 py-2 rounded-lg border border-transparent focus:border-mainColor transition-all"
                placeholder="Enter password"
              />
              <ErrorMessage
                name="ConfirmPassword"
              ...
              <div className="justify-between items-center flex ml-1 mt-3 text-sm md:text-base">
                <div className="checkbox flex gap-2 items-center">
                  ...
                  <p>
                    Agree with{" "}
                    <span className="text-mainColor">Terms & Conditions</span>
                  </p>
                </div>
              </div>
              ...
              <div className="log-in flex flex-col mx-auto mt-8">
                ...
                <span className="mx-auto mt-6 md:mt-10 text-[#00000080]">
                  or
                </span>
              </div>
              ...
              <div className="btns mb-10 md:mb-20 mx-auto  flex md:flex-col mt-10 gap-4">
                <button className="bg-white focus:outline-none md:px-32 md:py-3 px-6 py-5 rounded-lg flex justify-center items-center gap-4 cursor-pointer border border-gray-100 hover:bg-gray-50 transition-colors">
                  ...
                  <span className="hidden md:flex">Sign with</span>Facebook
                </button>
                <button className="bg-white focus:outline-none md:px-32 md:py-3 px-6 py-5 rounded-lg  flex justify-center items-center gap-4 cursor-pointer border border-gray-100 hover:bg-gray-50 transition-colors">
                  <span>
                    <FcGoogle className="text-xl" />
                  </span>
                  <span className="hidden md:flex">Sign with</span>Google
                </button>
              </div>
            </Form>
          </Formik>
