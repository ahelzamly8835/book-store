  ...
  return (
    <div className="min-h-screen pt-10 md:pt-0 flex flex-col bg-[#F5F5F5]">
      ...
      <div className="content justify-center items-center flex-col gap-16 mt-16 flex">
        ...
        <p className="text-[#22222280] w-58 md:w-full flex justify-center md:text-[16px] text-[2em]">
        ...
        <Formik>
          <Form className="form flex gap-5">
            <Field
              ...
              name="num"
              type="num"
              className="bg-white mt-4 flex md:w-[3em] w-[1em] focus:outline-none px-4 py-2 rounded-lg border border-gray-300 focus:border-mainColor transition-all"
            />
            <Field
              id="num"
              name="num"
      ...
      <div className="btn md:w-[35em] w-[22em] mb-60 mt-10 mx-auto">
        ...
        <div className="flex justify-center mt-16">
          <p className="text-[#222222]">
            ...
            <span className="cursor-pointer text-mainColor font-semibold">
              Send again
            </span>
          </p>
        </div>
